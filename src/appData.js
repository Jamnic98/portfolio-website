const projects = [
    {
        ...
        longDescription: [
            `Built with React, this project was created to make playing the board game version of Scrabble
             more enjoyable and less time-consuming by offloading the task of calculating player scores to a computer.`,
            `It features an easy-to-use graphical user interface comprised of a virtual Scrabble board and a table
             for displaying player scores. A dictionary is included to validate each word formed by the players.
             The board, table and tiles were styled using CSS.`,
        ...
        longDescription: [`
            This program was written in Java and interfaces with a MySQL database to store a
             list of books the user wants to read and has already read. It also stores information about the
             book such as the title, author, a rating out of 10 and also any comments about the book.`
        ],
